//ng-text支持ng双向绑定   text支持html代码、字符串
//强制推荐使用flex布局方式
...
app = angular.module("eenIcon",[]).directive("eenIcon",function(){
    return {
        ...
        <div>
            ...
            <section ng-if="strText" style="margin-top:2px;white-space:nowrap;{{cell}};-webkit-align-self:center;align-self:center;" ng-bind-html="strText"></section>
        </div>
        `.trim(),
